...
export default function FoodTrucks() {
  ...
  return (
    <div className="min-h-screen bg-white">
      <Helmet>
        <title>Food Truck POS Systems &amp; Payment Processing | Merchant Solutions Corp</title>
        <meta property="og:title" content="Food Truck POS Systems &amp; Payment Processing" />
        <meta property="og:description" content="Mobile POS systems and payment processing for food trucks. Accept payments anywhere your food truck goes." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://merchantsolutionscorp.com/industries/food-trucks" />
        <meta name="description" content="Mobile POS systems and payment processing for food trucks. Accept credit cards, mobile wallets, and contactless payments anywhere your food truck goes." />
        <meta name="keywords" content="food truck POS, mobile payment processing, food truck credit card processing, portable POS system" />
        <link rel="canonical" href="https://merchantsolutionscorp.com/industries/food-trucks" />
      </Helmet>

      <section className="bg-gradient-to-br from-gray-900 via-purple-950 to-gray-900 text-white py-24 md:py-32">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold mb-6">Food Truck POS Systems &amp; Payment Processing</h1>
          <p className="text-xl text-gray-300 mb-8">Mobile POS systems and payment processing designed for food trucks. Accept payments anywhere your food truck goes.</p>
