  ...
  return (
    <div className="min-h-screen bg-white">
      <Helmet>
        ...
        <link rel="canonical" href="https://merchantsolutionscorp.com/pos/square" />
        <script type="application/ld+json">{JSON.stringify({"@context":"https://schema.org","@type":"Service","name":"Square Point of Sale Systems","serviceType":"Authorized Square POS Dealer, Installation and Training","provider":{"@type":"Organization","name":"Merchant Solutions Corp","url":"https://merchantsolutionscorp.com"},"areaServed":"United States","url":"https://merchantsolutionscorp.com/pos/square","description":"Authorized Square dealer providing complete Square POS setup, installation, training, and ongoing support across all 50 U.S. states."})}</script>
        <script type="application/ld+json">{JSON.stringify({"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"https://merchantsolutionscorp.com/"},{"@type":"ListItem","position":2,"name":"POS Systems","item":"https://merchantsolutionscorp.com/pos-systems"},{"@type":"ListItem","position":3,"name":"Square POS","item":"https://merchantsolutionscorp.com/pos/square"}]})}</script>
