  ...
  return (
    <div className="min-h-screen bg-white">
      <Helmet>
        ...
        <link rel="canonical" href="https://merchantsolutionscorp.com/medical-clinic-payment-processing" />
        <script type="application/ld+json">{JSON.stringify({"@context":"https://schema.org","@type":"Service","name":"Medical Clinic Payment Processing","serviceType":"Medical Payment Processing and EMR Integration","provider":{"@type":"Organization","name":"Merchant Solutions Corp","url":"https://merchantsolutionscorp.com"},"areaServed":"United States","url":"https://merchantsolutionscorp.com/medical-clinic-payment-processing","description":"Secure medical payment processing integrated with leading EMR systems for medical offices and urgent care clinics."})}</script>
        <script type="application/ld+json">{JSON.stringify({"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"https://merchantsolutionscorp.com/"},{"@type":"ListItem","position":2,"name":"Healthcare","item":"https://merchantsolutionscorp.com/industries/healthcare"},{"@type":"ListItem","position":3,"name":"Medical Clinics","item":"https://merchantsolutionscorp.com/medical-clinic-payment-processing"}]})}</script>
