  ...
  return (
    <div className="min-h-screen bg-white">
      <Helmet>
        ...
        <link rel="canonical" href="https://merchantsolutionscorp.com/solutions/crypto-processing" />
        <script type="application/ld+json">{JSON.stringify({"@context":"https://schema.org","@type":"Service","name":"Cryptocurrency Processing","serviceType":"Cryptocurrency Payment Processing","provider":{"@type":"Organization","name":"Merchant Solutions Corp","url":"https://merchantsolutionscorp.com"},"areaServed":"United States","url":"https://merchantsolutionscorp.com/solutions/crypto-processing","description":"Accept cryptocurrency payments including Bitcoin and Ethereum at your business with Merchant Solutions Corp."})}</script>
        <script type="application/ld+json">{JSON.stringify({"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"https://merchantsolutionscorp.com/"},{"@type":"ListItem","position":2,"name":"Solutions","item":"https://merchantsolutionscorp.com/solutions/payment-processing"},{"@type":"ListItem","position":3,"name":"Crypto Processing","item":"https://merchantsolutionscorp.com/solutions/crypto-processing"}]})}</script>
      ...
      <section className="relative w-full min-h-[600px] md:min-h-[700px] overflow-hidden bg-gray-900 flex items-center">
        <img
          src="https://images.unsplash.com/photo-1772038408365-2ee983d2bf75?auto=format&fit=crop&w=1920&q=80"
          alt="Gold Bitcoin cryptocurrency coins"
