    ...
    clover: [
      {
        ...
        features: ['Compact countertop POS', 'Contactless & chip payments', 'Basic inventory management', 'Employee management'],
      ...
      },
      {
        ...
        requirement: '$15,000',
        reimbursement: 'Statement credit or subscription reimbursement',
        features: ['Portable wireless POS', 'Tableside ordering', 'Built-in printer & scanner', 'All-day battery life'],
      ...
      },
      {
        ...
        requirement: '$20,000',
        reimbursement: 'Statement credit or subscription reimbursement',
        features: ['14" HD touchscreen', 'Full POS software suite', 'Cash drawer & receipt printer', 'Advanced reporting'],
        color: 'border-purple-200',
      },
      {
        ...
        requirement: '$30,000',
        reimbursement: 'Statement credit or subscription reimbursement',
        features: ['Dual-screen system', 'Customer-facing display', 'Full restaurant or retail POS', 'Online ordering integration'],
    ...
    square: [
      {
        ...
        requirement: '$8,000',
        reimbursement: 'Statement credit or subscription reimbursement',
        features: ['All-in-one countertop terminal', 'Contactless, chip & swipe', 'Built-in receipt printer', 'Wi-Fi & Ethernet'],
        color: 'border-purple-200',
      },
      {
        ...
        requirement: '$15,000',
        reimbursement: 'Statement credit or subscription reimbursement',
        features: ['Dual-screen POS register', 'Customer-facing display', 'Full Square POS software', 'Integrated payments'],
        color: 'border-blue-200',
        badge: 'POPULAR',
      },
      {
        name: 'Square Stand + iPad',
        cost: '$69',
        requirement: '$12,000',
        reimbursement: 'Statement credit or subscription reimbursement',
        features: ['iPad-based POS system', 'Countertop or portable', 'Full Square ecosystem', 'Easy setup & training'],
        color: 'border-purple-200',
      },
    ],
    exatouch: [
      {
        ...
        requirement: '$12,000',
        reimbursement: 'Statement credit or subscription reimbursement',
        features: ['Touchscreen POS terminal', 'Barcode scanning', 'Inventory management', 'Employee time clock'],
        color: 'border-purple-200',
      },
      {
        name: 'Exatouch Pro',
        ...
        requirement: '$20,000',
        reimbursement: 'Statement credit or subscription reimbursement',
        features: ['Advanced POS system', 'Multi-station support', 'Advanced inventory & reporting', 'Loyalty program integration'],
        color: 'border-blue-200',
