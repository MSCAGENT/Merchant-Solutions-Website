  ...
  return (
    <div className="min-h-screen bg-white">
      <Helmet>
        ...
        <link rel="canonical" href="https://merchantsolutionscorp.com/best-self-ordering-kiosk-for-restaurants" />
        <script type="application/ld+json">{JSON.stringify({"@context":"https://schema.org","@type":"Service","name":"Self-Ordering Kiosk","serviceType":"Restaurant Self-Ordering Kiosk System","provider":{"@type":"Organization","name":"Merchant Solutions Corp","url":"https://merchantsolutionscorp.com"},"areaServed":"United States","url":"https://merchantsolutionscorp.com/best-self-ordering-kiosk-for-restaurants","description":"Self-ordering kiosk solutions for restaurants to increase order accuracy, speed, and average ticket size."})}</script>
        <script type="application/ld+json">{JSON.stringify({"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"https://merchantsolutionscorp.com/"},{"@type":"ListItem","position":2,"name":"POS Systems","item":"https://merchantsolutionscorp.com/pos-systems"},{"@type":"ListItem","position":3,"name":"Self-Ordering Kiosk","item":"https://merchantsolutionscorp.com/best-self-ordering-kiosk-for-restaurants"}]})}</script>
